                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                                ...
                                Text("x ${cartList[index].cartQty.toString()}")
                    ],
                  ),
                  ),
              );
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: IconButton(
                          ...
                          icon: const Icon(Icons.wallet),iconSize: 25,),
                    ),
                    const SizedBox(
                      height: 10,
                    ),
...
// }
    http.post(Uri.parse("${MyConfig().SERVER}/barterlt/php/add_to_order.php"),
    body: {
      "userid":widget.user.id,
      "sellerid": cartList[0].sellerId.toString(),
      "orderpaid" : cartList[0].cartPrice.toString(),
     "itemid" : cartList[0].itemId.toString(),
      "cartqty": cartList[0].cartQty.toString(),
    }).then((response) {        
      print(response.body);
      if(response.statusCode == 200){
        var jsondata = jsonDecode(response.body);
